...
$lang = require_once __DIR__ . '/../app/lang/es.php';
...
<body class="login-body">
    ...
    <aside class="login-panel">
        ...
        <div class="login-brand">
            <div class="login-brand__icon">C</div>
            <span class="login-brand__name">Coffmunnity</span>
        </div>
        ...
        <form class="login-form" action="index.php" method="POST" novalidate>
            ...
            <div class="login-field login-field--pass">
                <input
                    ...
                    required />
            <button type="button" class="login-field__eye" aria-label="<?= $loginLang['show_pass'] ?>">
            ...
            <label class="login-remember">
                ...
                <span class="login-remember__track">
                    <span class="login-remember__thumb"></span>
                </span>
                <span class="login-remember__label"><?= $loginLang['remember_me'] ?></span>
            </label>
        ...
        <div class="login-register">
            <span class="login-register__text">¿No tienes cuenta?</span>
            <a href="register.php" class="login-register__link">Regístrate</a>
        </div>
